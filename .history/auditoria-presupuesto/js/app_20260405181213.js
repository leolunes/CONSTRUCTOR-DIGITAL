...
function getBudgetDashboardChapterChartData(project){
  ...
  return {
    labels: sorted.map(r => r.label || "(Sin capítulo)"),
...
function getBudgetDashboardItemChartData(project){
  ...
  const ranked = rows
    .map(r=>{
      ...
      return {
        label: `${String(r.code || "").trim()} ${String(r.desc || "").trim()}`.trim(),
        impact,
  ...
  host.innerHTML = `
    ...
    <div class="grid two" style="gap:14px">
      <div class="card item">
        ...
        <div style="height:320px"><canvas id="budgetAuditChartChapters"></canvas></div>
      </div>
      ...
      <div class="card item">
        ...
        <div style="height:320px"><canvas id="budgetAuditChartItems"></canvas></div>
      </div>
    </div>
