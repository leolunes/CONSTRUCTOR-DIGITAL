...
function refreshPdfExportButtonsLabels(project){
  ...
  setText("btnPdfPresupuesto", `PDF Presupuesto ${modeLabel}`);
  setText("btnDlPdfPresupuesto", `Descargar PDF Presupuesto ${modeLabel}`);

  setText("btnPdfPresupuestoAPUs", `PDF Presupuesto ${modeLabel} + APUs`);
  setText("btnDlPdfPresupuestoAPUs", `Descargar PDF Presupuesto ${modeLabel} + APUs`);

  setText("btnPdfEspecificacionesTec", `PDF Especificaciones Técnicas ${modeLabel}`);
  setText("btnDlPdfEspecificacionesTec", `Descargar PDF Especificaciones Técnicas ${modeLabel}`);

  setText("btnPdfPresupuestoDesagregado", `PDF Presupuesto Desagregado ${modeLabel}`);
  setText("btnPdfResumenPresupuestoDesagregado", `PDF Resumen Desagregado ${modeLabel}`);
  setText("btnPdfDistribucionPctCD", `PDF Distribución % Costos Directos ${modeLabel}`);
  setText("btnPdfRendimientoEqMo", `PDF Rendimiento Eq./M.O. ${modeLabel}`);
  setText("btnPdfResumenMaterialesActividad", `PDF Materiales por Actividad ${modeLabel}`);
  setText("btnPdfCantRecursosInsumos", `PDF Recursos e Insumos ${modeLabel}`);
  setText("btnPdfCalculoIndirectos", `PDF Costos Indirectos ${modeLabel}`);
  setText("btnPdfCalcIndirectos", `PDF Costos Indirectos ${modeLabel}`);
...
function renderBudgetToolbar(project){
  ...
  host.innerHTML = `
    ...
    <div class="row" style="gap:8px; flex-wrap:wrap; margin-top:12px">
      ...
      <button type="button" class="btn" data-budget-audit-pdf>PDF Auditoría Base vs Oficial</button>
    </div>
