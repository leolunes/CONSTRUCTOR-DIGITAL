...
function getBudgetMode(){
  const mode = String(getParam("budgetMode") || getParam("mode") || "").toLowerCase();
...
window.UI = { qs, getParam, getBudgetMode, esc, chip, fmtBytes, fmtMoney, downloadBlobUrl, downloadFileFromIDB };