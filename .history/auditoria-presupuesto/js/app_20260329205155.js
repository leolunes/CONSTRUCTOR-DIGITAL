...
function getBudgetModeLabel(mode){
  return String(mode || "").toLowerCase() === "official" ? "OFICIAL" : "BASE";
}

function getBudgetModeBadge(mode){
  return String(mode || "").toLowerCase() === "official"
...
function getBudgetModeInfo(project){
  ...
  return {
    mode: String(activeMode || "").toLowerCase() === "official" ? "official" : "base",
...
function getProjectViewForBudget(project, mode){
  ...
  const targetMode = String(mode || "").toLowerCase() === "official" ? "official" : "base";
  const budget =
    (window.StorageAPI && typeof StorageAPI.getProjectBudget === "function")
      ? StorageAPI.getProjectBudget(project.id, targetMode)
      : (targetMode === "official" ? clone.budgetOfficial : clone.budgetBase);
