...
function ensureIndirectTableMount(form){
  ...
  // ✅ AJUSTE QUIRÚRGICO:
  // Si el HTML ya trae el bloque de indirectos, reutilizarlo y NO crear otro.
  ...
  host.innerHTML = `
    <div class="cardhead">
      ...
      <p class="muted small">Muestra el mismo desglose base del PDF: ÍTEM, GRUPO, DESCRIPCIÓN, UNID, CANT, VR UNIT, % DIR y VR PARCIAL.</p>
    </div>
