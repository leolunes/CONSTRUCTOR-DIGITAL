      ...
      >
        ...
        <td>
          <div style="margin-left:${indent}px">
            <input class="input" data-field="desc" value="${UI.esc(r.desc)}" placeholder="Descripción" ${r.sourceType!=="manual" ? "readonly" : ""}>
          </div>
        </td>
        <td><input class="input" data-field="unit" value="${UI.esc(isPercentCd ? "%CD" : r.unit)}" placeholder="MES" ${r.sourceType!=="manual" ? "readonly" : ""}></td>
        ...
        <td><input class="input" data-field="unitValue" type="number" step="any" value="${UI.esc(unitVal)}" ${r.sourceType!=="manual" ? "readonly" : ""}></td>
        <td>
