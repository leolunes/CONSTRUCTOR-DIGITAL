...
function renderBudgetIndirectComparison(project){
  ...
  let wrap = UI.qs("#budgetComparisonIndirects");
  if(!wrap){
    wrap = document.createElement("div");
    wrap.id = "budgetComparisonIndirects";
  ...
  const indirect = getBudgetIndirectComparison(project);
  const currency = indirect.currency || "COP";
