...
function exportAuditPdf(project){
  ...
  addTitle("4. Top de riesgos presupuestales");
  ...
  addTitle("5. Historial reciente de cambios");
  ...
  addTitle("6. Conclusión automática");
  ...
  addParagraph(
    ...
    + `Se identificaron ${highAlerts} ítems con alerta automática, ${riskTopRows.length} riesgos priorizados en el ranking y ${positiveChapters} capítulos con variación positiva frente al presupuesto base. `
