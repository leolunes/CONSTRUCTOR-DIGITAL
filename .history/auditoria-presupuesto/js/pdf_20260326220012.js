(function(){
  ...
  async function getAPUForProjectItem(project, it){
    ...
    // =========================================================
    // 1) SI HAY apuRefCode, CONFIAR EN ESA REFERENCIA
    //    y NO bloquear por descripción/unidad
    // =========================================================
    if(hasRealRef){
    ...
    // =========================================================
    // 2) SIN apuRefCode: intentar code visible con validación
    // =========================================================
    if(c2){
     ...
     // =========================================================
    // 3) ÚLTIMO RECURSO: búsqueda por descripción con validación fuerte
    // =========================================================
      ...
      for(const info of subproductosUsados.values()){
        ...
        try{
          const ov = window.StorageAPI?.getSubApuOverride
            ? StorageAPI.getSubApuOverride(project.id, subKey)
            : null;
        ...
        const fuente = safe(subAPU.metaLine || (subAPU.mode === "sub_override" ? "Fuente: Override del proyecto" : "Fuente: Subproductos"));
        L.p(fuente);
