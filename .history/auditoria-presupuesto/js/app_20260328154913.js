...
function setIndirectManualInputsDisabled(form, ){
  if(!form) return;
  ...
  tbody.innerHTML = rows.map(row=>{
    ...
    return `
      ...
      >
        ...
        <td><input class="input" data-field="qty" type="number" step="any" value="${UI.esc(String(isPercentCd ? 1 : (r.qty||0)))}" ${isPercentCd ? "" : ""}></td>
        <td><input class="input" data-field="unitValue" type="number" step="any" value="${UI.esc(unitVal)}" ></td>
        <td>
          <div class="row" style="gap:6px; flex-wrap:wrap">
            <select class="input" data-field="calcType" style="min-width:120px" ${isPercentCd ? "" : ""}>
