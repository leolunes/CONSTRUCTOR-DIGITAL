...
function ensureIndirectTableMount(form){
  ...
  host.innerHTML = `
    <div class="cardhead">
      ...
      <p class="muted small">Modo jerárquico con subtítulos, sub-subtítulos y líneas de detalle por numeración.</p>
    </div>
    ...
    <div class="grid two" style="margin-bottom:12px">
      ...
      <div id="indirectModeHint" class="card item">
        ...
        <div class="muted small">Crea subtítulos tipo 1, 1.2, 1.2.1 y luego agrega líneas bajo esa numeración.</div>
      </div>
    </div>
