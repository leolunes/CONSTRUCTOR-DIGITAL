...
function calcTotals(project){
  ...
  const hasTable = Array.isArray(project?.indirectTable) && project.indirectTable.length > 0;

  // 🔧 FIX: si hay tabla cargada, forzar modo table
  if(indirectMode === "table" || hasTable){
