...
function bindProjectExports(projectId){
  ...
  UI.qs("#btnPdfBase")?.addEventListener("click", async ()=>{
    ...
    if(!p) return;
    try{
      await PDF.exportPresupuestoPDF(p, { mode:"base" });
    }catch(err){
  ...
  UI.qs("#btnPdfOfficial")?.addEventListener("click", async ()=>{
    ...
    if(!p) return;
    try{
      await PDF.exportPresupuestoPDF(p, { mode:"oficial" });
    }catch(err){
  ...
  UI.qs("#btnPdfPresupuesto")?.addEventListener("click", async ()=>{
    ...
    if(!p) return;
    try{
      await PDF.exportPresupuestoPDF(p, { mode:getBudgetModeFromUI(), share:true });
    }catch(err){
  ...
  UI.qs("#btnDlPdfPresupuesto")?.addEventListener("click", async ()=>{
    ...
    if(!p) return;
    try{
      await PDF.exportPresupuestoPDF(p, { mode:getBudgetModeFromUI(), share:false });
    }catch(err){
  ...
  UI.qs("#btnPdfPresupuestoAPUs")?.addEventListener("click", async ()=>{
    ...
    if(!p) return;
    try{
      await PDF.exportPresupuestoConAPUsPDF(p, { mode:getBudgetModeFromUI(), share:true });
    }catch(err){
  ...
  UI.qs("#btnDlPdfPresupuestoAPUs")?.addEventListener("click", async ()=>{
    ...
    if(!p) return;
    try{
      await PDF.exportPresupuestoConAPUsPDF(p, { mode:getBudgetModeFromUI(), share:false });
    }catch(err){
  ...
  UI.qs("#btnPdfPresupuestoDesagregado")?.addEventListener("click", async ()=>{
    ...
    if(!p) return;
    try{
      await PDF.exportPresupuestoObraDesagregadoPDF(p, { mode:getBudgetModeFromUI(), share:true });
    }catch(err){
  ...
  UI.qs("#btnPdfResumenPresupuestoDesagregado")?.addEventListener("click", async ()=>{
    ...
    if(!p) return;
    try{
      await PDF.exportResumenPresupuestoObraDesagregadoPDF(p, { mode:getBudgetModeFromUI(), share:true });
    }catch(err){
  ...
  UI.qs("#btnPdfDistribucionPctCD")?.addEventListener("click", async ()=>{
    ...
    if(!p) return;
    try{
      await PDF.exportDistribucionPorcentualCostosDirectosPDF(p, { mode:getBudgetModeFromUI(), share:true });
    }catch(err){
  ...
  UI.qs("#btnPdfRendimientoEqMo")?.addEventListener("click", async ()=>{
    ...
    if(!p) return;
    try{
      await PDF.exportRendimientoEquipoYManoDeObraPorActividadPDF(p, { mode:getBudgetModeFromUI(), share:true });
    }catch(err){
  ...
  UI.qs("#btnPdfResumenMaterialesActividad")?.addEventListener("click", async ()=>{
    ...
    if(!p) return;
    try{
      await PDF.exportResumenMaterialesPorActividadPDF(p, { mode:getBudgetModeFromUI(), share:true });
    }catch(err){
  ...
  UI.qs("#btnPdfCantRecursosInsumos")?.addEventListener("click", async ()=>{
    ...
    if(!p) return;
    try{
      await PDF.exportCantidadRecursosEInsumosPresupuestoPDF(p, { mode:getBudgetModeFromUI(), share:true });
    }catch(err){
  ...
  UI.qs("#btnPdfEspecificacionesTec")?.addEventListener("click", async ()=>{
    ...
    if(!p) return;
    try{
      await PDF.exportEspecificacionesTecnicasPDF(p, { mode:getBudgetModeFromUI(), share:true });
    }catch(err){
  ...
  UI.qs("#btnDlPdfEspecificacionesTec")?.addEventListener("click", async ()=>{
    ...
    if(!p) return;
    try{
      await PDF.exportEspecificacionesTecnicasPDF(p, { mode:getBudgetModeFromUI(), share:false });
    }catch(err){
...
async function bindProjectDetailPage(){
  ...
  // Normalizar con ProjectModel si existe
