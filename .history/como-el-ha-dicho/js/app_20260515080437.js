...
async function generarPdfPalabra(){
    ...
    // =====================================
    // ENCABEZADO SOLO CON LOGO REAL DE LA APP
    // =====================================
    ...
    // Fondo claro y suave para no opacar el mensaje
    pdf.setFillColor(
        255,
        255,
        255
    ...
    // Logo real de lado a lado, más discreto y limpio
    if(logoApp){
    ...
    y += lineasDeclaracion.length * 7 + 22;
