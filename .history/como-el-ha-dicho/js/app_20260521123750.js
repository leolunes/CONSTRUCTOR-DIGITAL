...
// Ahora intenta compartir el PDF real como archivo.
// Si el navegador no lo permite, descarga el PDF
// y abre WhatsApp con el mensaje como respaldo.
// =====================================
...
async function compartirWhatsAppPalabra(){
    ...
    try{
        ...
        // Respaldo para navegadores que no permiten compartir archivos.
        await generarPdfPalabra(
            'descargar'
        );
