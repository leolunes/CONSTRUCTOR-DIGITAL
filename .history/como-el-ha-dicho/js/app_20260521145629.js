...
// 1. Intenta compartir el PDF como archivo real.
// 2. Si el celular no lo permite, solo descarga el PDF.
// 3. NO abre enlaces de WhatsApp para evitar error 404.
// =====================================
    ...
    try{
        ...
        if(
            ...
            await navigator.share({
                ...
                title:
                'Palabra Victoriosos en Cristo',

                text:
                'Te comparto esta palabra preparada especialmente para ti.',
        ...
        alert(
            'Tu celular no permitió compartir el PDF directamente. El PDF fue descargado. Ahora abre WhatsApp y adjunta manualmente el archivo desde Descargas.'
        );
        ...
        alert(
            'No se pudo compartir automáticamente. El PDF fue descargado. Envíalo por WhatsApp como archivo adjunto desde la carpeta Descargas.'
        );
...
async function generarPdfPalabra(modo = 'descargar'){
    ...
    // =====================================
    // DEDICATORIA
    // AJUSTE VISUAL PARA EVITAR
    // SUPERPOSICIÓN Y CORTES
    // =====================================
