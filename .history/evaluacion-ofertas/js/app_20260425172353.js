...
function requiereProyectoActivo() {
  ...
  if (!proyectoId) {
    alert("Primero cree o cargue un proyecto antes de agregar documentos anexos.");
    return null;
  }
...
function renderDocumentosAnexos() {
  ...
  if (!proyectoId) {
    ...
    li.textContent = "Primero cree o cargue un proyecto para asociar documentos anexos.";
    listaDocs.appendChild(li);
    return;
  }

  const docs = DB.proceso.documentosAnexos.filter(doc =>
