  ...
  reader.onload = function (e) {
    try {
      ...
      json.slice(inicioDatos).forEach((fila, idx) => {
        ...
        // =========================================================
        // AJUSTE 2026-04-27
        // Antes la importación exigía valor > 0 y podía omitir una propuesta válida.
        // Ahora se importa toda fila que tenga nombre de proponente real, incluso si el valor leído es 0.
        // Las filas totalmente vacías o encabezados siguen siendo ignorados.
        // =========================================================
        const filaTieneDatosAdicionales = fila.some(celda => String(celda || "").trim() !== "");

        if (empresa && filaTieneDatosAdicionales) {
          ...
          filasLimpias.push({
            empresa,
            oferta: Number.isFinite(Number(valor)) ? valor : 0,
            puntajeEconomico,
            puntajeCalidad,
            puntajeSostenibilidad,
            puntajeIndustria,
